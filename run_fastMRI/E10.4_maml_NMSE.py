...
########################### experiment name ###########################
experiment_name = "E10.4_maml(NMSE-lre-3)_T8x50_250epoch"
# "E10.3_maml(NMSE-lrCAe-3-4)_T8x200_250epoch"
# "E10.3_maml(NMSE-lre-3)_T8x200_250epoch"
...
for iter_ in range(EPOCH):    
    ...
    for val_iter in range(8): 
        ...
        model_copy = tuning(model_copy, adapt_dataloader_list[val_iter], epoch = 1)
