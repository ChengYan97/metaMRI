...
experiment_name = 'E12.2_maml(l1_-5)'+ DOMAIN +'_T300_from150epoch'
checkpoint_path = '/cheng/metaMRI/metaMRI/save/E12.1_joint(l1_1e-5)P_T300_300epoch/E_12.1_joint(l1_1e-5)P_T300_300epoch_E150_best.pth'
...
for iter_ in range(EPOCH):    
    ...
    # checkpoint
    save_path = '/cheng/metaMRI/metaMRI/save/'+ experiment_name + '/' + experiment_name + '_E' + str(iter_+301) + '.pth'
