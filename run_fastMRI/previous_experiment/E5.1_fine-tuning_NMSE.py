...
experiment_name = 'E5.1_maml-100shot-tuning_NMSE_AXFLAIR_Skyra'
...
num_sample_val = 300
path_train = '/cheng/metaMRI/metaMRI/data_dict_narrow/brain_train_AXFLAIR_Skyra.yaml'
path_val = '/cheng/metaMRI/metaMRI/data_dict_narrow/brain_val_AXFLAIR_Skyra.yaml'
#  AXT1_Aera, AXT2_Aera
checkpoint_path = '/cheng/metaMRI/metaMRI/save/E5.1/E5.1_maml_T9x100_200epoch/E5.1_maml_T7x200_200epoch_E191_best.pth'
#checkpoint_path = '/cheng/metaMRI/metaMRI/save/E5.1/E5.1_pretrain_T9x100_100epoch/E5.1_pretrain_T9x100_100epoch_E78_best.pth'
...
testset = SliceDataset(dataset = path_val, path_to_dataset='', path_to_sensmaps=None, provide_senmaps=False, 
                    challenge="multicoil", transform=data_transform_test, use_dataset_cache=True, num_samples= num_sample_val)
...
for iteration in range(TRAINING_EPOCH):
    ...
    writer.add_scalar("Fine-tuning NMSE", train_loss_history[iteration], iteration)
    # val
    evaluate(model, test_dataloader, val_loss_history)
    writer.add_scalar("Testing NMSE", val_loss_history[iteration], iteration)
    # 
