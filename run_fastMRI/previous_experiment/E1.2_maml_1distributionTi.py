...
########################### experiment name ###########################
experiment_name = 'E1.2_maml_1Ti_dataset1x500_50epoch__'
...
start_epoch = -1
if BREAKPOINT:
    path_checkpoint = "/cheng/metaMRI/metaMRI/save/E1.2/E1.2_maml_1Ti_dataset1x500_50epoch_/E1.2_maml_1Ti_dataset1x500_50epoch__E50.pth"  
...
for out_iter in range(start_epoch, OUTER_EPOCH):    # time step
    ...
    # update the last epoch real model 2 times -> learner
