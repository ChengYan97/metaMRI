...
experiment_name = 'E1.1_train_1dataset500_70epoch'
...
train_dataloader = torch.utils.data.DataLoader(dataset = trainset_kneePD, batch_size = 1, num_workers = 8, 
...
for iteration in range(TRAINING_EPOCH):
    ...
    if validation_loss < best_validation_loss:
        save_path_epoch = experiment_path + experiment_name + '_E' + str((iteration+1)) + '_best.pth'
