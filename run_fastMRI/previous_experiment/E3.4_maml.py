...
########################### experiment name ###########################
experiment_name = 'E3.4_maml_T3x300_70epoch'
...
for outer_iter in range(Outer_EPOCH):    
    ...
    for i in tqdm(sample_list): 
        ...
        total_update_loss += update_loss.item()
    ...
    print("Meta Training NMSE (MAML)", total_update_loss/len(sample_list))
    writer.add_scalar("Meta Training NMSE (MAML)", total_update_loss/len(sample_list), outer_iter+1)
