...
experiment_name = 'E11.8_joint(l1_CA-1e-3-4_Q)_T300_150epoch'
...
data_transform_train = UnetDataTransform_TTTpaper('multicoil', mask_func = mask_function, use_seed=False, mode='train')
...
def train(model, dataloader, optimizer): 
    ...
    for iter, batch in tqdm(enumerate(dataloader)):
        ...
        loss_self = l1_loss(Fimg_forward.squeeze(0), input_kspace) / torch.sum(torch.abs(input_kspace))
