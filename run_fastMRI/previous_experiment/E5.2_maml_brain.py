...
########################### experiment name ###########################
experiment_name = 'E5.2_maml_T9x100_200epoch'
...
K = 8      # K examples for inner loop training
K_update = 2
adapt_steps = 2
...
train_dataloader_2 = torch.utils.data.DataLoader(dataset = trainset_2, batch_size = K + K_update,
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = True)
train_dataloader_3 = torch.utils.data.DataLoader(dataset = trainset_3, batch_size = K + K_update,
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = True)
train_dataloader_4 = torch.utils.data.DataLoader(dataset = trainset_4, batch_size = K + K_update,
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = True)
train_dataloader_5 = torch.utils.data.DataLoader(dataset = trainset_5, batch_size = K + K_update,
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = True)
train_dataloader_6 = torch.utils.data.DataLoader(dataset = trainset_6, batch_size = K + K_update,
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = True)
train_dataloader_7 = torch.utils.data.DataLoader(dataset = trainset_7, batch_size = K + K_update, 
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = True)
train_dataloader_8 = torch.utils.data.DataLoader(dataset = trainset_8, batch_size = K + K_update, 
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = True)
train_dataloader_9 = torch.utils.data.DataLoader(dataset = trainset_9, batch_size = K + K_update, 
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = True)

in_tuning_dataloader = torch.utils.data.DataLoader(dataset = in_tuning_set, batch_size = 1, 
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = False)
out_tuning_dataloader = torch.utils.data.DataLoader(dataset = out_tuning_set, batch_size = 1, 
                    shuffle = True, generator = torch.Generator().manual_seed(1), pin_memory = False)
in_validation_dataloader = torch.utils.data.DataLoader(dataset = in_val_set, batch_size = 1, 
                    shuffle = False, generator = torch.Generator().manual_seed(1), pin_memory = False)
out_validation_dataloader = torch.utils.data.DataLoader(dataset = out_val_set, batch_size = 1, 
                    shuffle = False, generator = torch.Generator().manual_seed(1), pin_memory = False)
