...
experiment_name = 'E4.1_maml-10shot-tuning_SSIM_brainAXT2'
...
num_sample_train = 10
num_sample_val = 300
path_train = '/cheng/metaMRI/metaMRI/data_dict/brain_train_AXT2.yaml'
# knee_train_CORPD, brain_train_AXFLAIR
path_val = '/cheng/metaMRI/metaMRI/data_dict/brain_val_AXT2.yaml'
#  knee_val_CORPD, brain_val_AXFLAIR
checkpoint_path = '/cheng/metaMRI/metaMRI/save/E4.1/E4.1_maml_T3x300_100epoch/E4.1_maml_T3x300_100epoch_E96_best.pth'
#checkpoint_path = '/cheng/metaMRI/metaMRI/save/E_pretrain_T3x300_100epoch/E2.2_pretrain_T3x300_100epoch.pth'
...
def train(model, dataloader, optimizer, train_loss_history): 
    ...
    print('Training SSIM', avg_train_loss) 
...
for iteration in range(TRAINING_EPOCH):
    ...
    writer.add_scalar("Training SSIM", train_loss_history[iteration], iteration)
    # val
    evaluate(model, test_dataloader, val_loss_history)
    writer.add_scalar("Validation SSIM", val_loss_history[iteration], iteration)
    # 
