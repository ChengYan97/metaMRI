...
########################### experiment name ###########################
experiment_name = 'E6.2_maml(SSIM_1st-order)_CAlr_T2x300_200epoch'
...
######: first order MAML ######
EPOCH = 200   
# enumalate the whole data once takes 100 outer loop
Inner_EPOCH = 1
...
scheduler = CosineAnnealingLR(optimizer, T_max= 20000, eta_min=0, last_epoch=-1)
