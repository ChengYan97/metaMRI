...
class SliceDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i: int): 
        ...
        with h5py.File(filepath, "r") as hf:
            ...
            #if self.use_SENSE_targets:
            #    max_value_fname = filename + '_max_value_SENSE1Recon.h5'
            #    with h5py.File(self.path_to_max_vals + max_value_fname, "r") as hf_mv:
            #        max_value_SENSE1Recon = hf_mv["max_value_SENSE1Recon"][()] # scalar float
            #        attrs.update({'max_value_SENSE1Recon' : max_value_SENSE1Recon})

        #if self.transform is None:
        #    sample = (kspace, sens_maps, target, attrs, filename, dataslice)
        #else:
