...
####################################################################################
experiment_name = 'E6.2_maml_adapt_P1'

checkpoint_path = '/cheng/metaMRI/metaMRI/save/E6.2_maml(NMAE)_T2x300_200epoch/E6.2_maml(NMAE)_T2x300_200epoch_E178_best.pth'
...
path_adapt = '/cheng/metaMRI/metaMRI/data_dict/E6.1/knee_train_PD_Skyra_15-22.yaml'
# '/cheng/metaMRI/metaMRI/data_dict/E6.1/knee_train_PD_Skyra_15-22.yaml'
# '/cheng/metaMRI/metaMRI/data_dict/E6.1/knee_train_PDFS_Aera_15-22.yaml'
...
path_test = '/cheng/metaMRI/metaMRI/data_dict/E6.1/knee_test_PD_Skyra_15-22.yaml'
...
for iteration in range(TRAINING_EPOCH):
    ...
    print('Adapt NMAE', training_loss) 
    writer.add_scalar("Adapt NMAE", training_loss, iteration+1)
    # val
    ...
    writer.add_scalar("Testing", validation_loss_NMSE, iteration+1)
